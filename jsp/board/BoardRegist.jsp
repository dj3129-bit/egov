					...
					<tr>
						...
						<td>
							...
							<input type="radio" id="noticeAtY" value="Y" name="noticeAt"
								<c:if test="${not empty result and result.noticeAt == 'Y'}">checked="checked"</c:if>/>
							&nbsp;&nbsp;&nbsp;
...
<script src="https://cdn.tiny.cloud/1/9qklgx6iigxzs8l9dzc8yy7nqjcf5x8a4s6dce2pnikt8if3/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
